                ...
                >
                  ...
                  >
                    <span className="rn-pd-sm-thumbnail">
                      <img
                        src={property?.images ? property?.images : "/portfolio/portfolio-01.jpg"}
                        alt="Nft_Profile"
                      />
                    </span>
                  </button>
          ...
          <div className="col-lg-5 col-md-12 col-sm-12 mt_md--50 mt_sm--60">
            <div className="rn-pd-content-area">
              <div className="pd-title-area">
                <h4 className="title">{property?.propertyName?.slice(0, 25)}</h4>
                        ...
                        <div className="rn-pd-sm-property-wrapper">
                          ...
                          <div className="pd-property-inner">
                            <h6 className="pd-property-title">
                              {" "}
                              Price 18 Decimal Points: {property?.price} POL
                            </h6>
                          </div>
                          <div className="pd-property-inner">
                            <h6 className="pd-property-title">
                    ...
                    {buyLoading ? (
                      ...
                      <>
                        {address?.toLowerCase() == property?.owner?.toLowerCase()
                          ...
                          : `${property?.price} POL Buy Property`}
                      </>
                    )}
                  </button>
                  <button
