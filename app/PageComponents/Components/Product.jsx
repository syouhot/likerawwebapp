        ...
        <div className="col-lg-12">
          <div className="grid-metro5 mesonry-list" style={{ display: 'flex', flexWrap: 'wrap'}}>
            ...
            <div className="grid-metro-item cat--1 cat--3">
              <div className="product-style-one no-overlay with-placeBid" style={{position: 'relative !important'}}>
            ...
            <div className="grid-metro-item cat-3 cat--4" style={{position: 'relative !important'}}>
            ...
            <div className="grid-metro-item cat--5 cat--6" style={{position: 'relative !important'}}>
              <div className="product-style-one no-overlay with-placeBid">
                <div className="card-thumbnail">
                  <a href="product-details.html">
                    <img
            ...
            <div className="grid-metro-item cat--1 cat--2" style={{position: 'relative !important'}}>
              <div className="product-style-one no-overlay with-placeBid">
                <div className="card-thumbnail">
                  <a href="product-details.html">
                    <img
            ...
            <div className="grid-metro-item cat--5 cat--4" style={{position: 'relative !important'}}>
              <div className="product-style-one no-overlay with-placeBid">
                <div className="card-thumbnail">
                  <a href="product-details.html">
                    <img
            ...
            <div className="grid-metro-item cat--1 cat--3" style={{position: 'relative !important'}}>
              <div className="product-style-one no-overlay with-placeBid">
                <div className="card-thumbnail">
                  <a href="product-details.html">
                    <img
